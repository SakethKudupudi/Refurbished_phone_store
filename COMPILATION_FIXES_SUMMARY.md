...
## How to Run with Azure SQL Server

```bash
# Set environment variables
export AZURE_SQL_SERVER="your-server.database.windows.net"
export AZURE_SQL_DATABASE="mobileparts"
export AZURE_SQL_USERNAME="appuser"
export AZURE_SQL_PASSWORD="YourPassword"

# Run with sqlserver profile
...
3. ⏳ Start backend with SQL Server connection
4. ⏳ Connect Angular frontend to backend APIs
5. ⏳ Test end-to-end flow

## Related Documentation

- [Azure SQL Setup Guide](AZURE_SQL_SETUP.md)
